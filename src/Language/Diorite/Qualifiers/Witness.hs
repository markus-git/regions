...
witSubAdd a (QualPred b bs) c Refl =
...
witExtRefl (QualPred a as) | Refl <- witExtRefl as = Refl
...
witExtSub (QualPred (a :: Proxy q) (as :: QualRep qs)) b Refl =
